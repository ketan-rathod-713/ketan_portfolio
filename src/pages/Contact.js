...
function Contact() {
  ...
  return <div className={`${theme==='dark' ? 'bg-gray-800 text-white':'bg-white'} flex justify-start`}>
    ...
    <input className={`px-5 py-3 text-xl sm:w-[600px] border border-gray-700 ${theme==='dark' ? 'bg-gray-700 text-white':''}`} placeholder="Email" type="text" name="email" id="" />
    <input className={`px-5 py-3 text-xl sm:w-[600px] border border-gray-700 ${theme==='dark' ? 'bg-gray-700 text-white':''}`}  placeholder="Name" type="text" name="email" id="" />
    <textarea className={`px-5 py-3 text-xl sm:w-[600px] border border-gray-700 ${theme==='dark' ? 'bg-gray-700 text-white':''}`}  placeholder="Message" type="text" name="email" id="" />
